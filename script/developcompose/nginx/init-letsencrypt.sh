...
domains="devserver.jabiseo.com"
rsa_key_size=4096
data_path="./data/certbot"
email="ss112d86@gmail.com" # Adding a valid address is strongly recommended
...
docker compose exec webserver nginx -s reload // 리로드는 도커 컴포즈 서비스 명으로 실행
